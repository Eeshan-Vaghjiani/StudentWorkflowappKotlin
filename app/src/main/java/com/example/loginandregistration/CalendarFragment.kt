...
class CalendarFragment : Fragment() {
    ...
    private fun updateCalendarDayBinder(datesWithTasks: Set<LocalDate>, selectedDate: LocalDate) {
        val dayBinder = CalendarDayBinder(
        ...
        calendarView.dayBinder = object : MonthDayBinder<CalendarDayBinder.DayViewContainer> {
            override fun create(view: View) = dayBinder.DayViewContainer(view)
            override fun bind(container: CalendarDayBinder.DayViewContainer, data: CalendarDay) {
